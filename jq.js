...
!function(e, t) {
    ...
    function c(e, t, n, r) {
        if (it.acceptData(e)) {
            ...
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = s ? e[a] = J.pop() || it.guid++ : a),
                l[u] || (l[u] = s ? {} : {
                    toJSON: it.noop
                }),
    ...
    function O(e, t, n) {
        ...
        u = it.css(e, "display"),
        c = "none" === u ? it._data(e, "olddisplay") || E(e.nodeName) : u,
    ...
    var ut = function(e) {
        ...
        L = t.setDocument = function(e) {
            ...
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n,
            _ = n.documentElement,
            q = !N(n),
            ...
            t = vt.test(_.compareDocumentPosition),
            B = t || vt.test(_.contains) ? function(e, t) {
    ...
    it.event = {
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = c = r = r || ht,
            3 !== r.nodeType && 8 !== r.nodeType && !qt.test(p + it.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            a = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                if (!i && !u.noBubble && !it.isWindow(r)) {
                    ...
                    qt.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                        f.push(s),
                        c = s;
                ...
                if (t.type = p,
                !i && !t.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), n) === !1) && it.acceptData(r) && a && r[p] && !it.isWindow(r)) {
                    c = r[a],
                    c && (r[a] = null),
            ...
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                o || 0 === o)
                    if ("object" === it.type(o))
                        ...
                        !nt.tbody)
                            for (o = "table" !== l || $t.test(o) ? "<table>" !== c[1] || $t.test(o) ? 0 : s : s.firstChild,
    ...
    it.extend({
        ...
        ajax: function(e, t) {
            ...
            w.success = w.done,
            w.error = w.fail,
            d.url = ((e || d.url || Mn) + "").replace(On, "").replace(Wn, qn[1] + "//"),
            d.type = t.method || t.type || d.method || d.type,
            d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(bt) || [""],
            null == d.crossDomain && (r = $n.exec(d.url.toLowerCase()),
            d.crossDomain = !(!r || r[1] === qn[1] && r[2] === qn[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (qn[3] || ("http:" === qn[1] ? "80" : "443")))),
